...
public class PaySomeone {    
    public void openPopup(JFrame frame,String fromAccountNumber) {
        showDepositPopup(frame,fromAccountNumber);
    }

    private static void showDepositPopup(JFrame parent,String fromAccountNumber) {
        ...
        JLabel accountNumberLabel = new JLabel("To Account Number:");
        gbc.gridx = 0;
        gbc.gridy = 0;
...
//                    dayField.requestFocus();
        ...
        confirmButton.addActionListener((ActionEvent e) -> {
            String toAccountNumber = accountNumberField.getText().trim();
            ...
            // Validate input
            if (toAccountNumber.isEmpty() || year.isEmpty() || month.isEmpty() || day.isEmpty() || balance.isEmpty() || description.isEmpty()) {
            ...
            try {
                ...
                if(confirmationResponse == JOptionPane.OK_OPTION) {
                    ...
                    boolean result = transactionController.paySomeone(fromAccountNumber, toAccountNumber, amount, description, reference.isEmpty() ? "" : reference);
                    if(result){
