...
public class ATMDeposit {
    ...
    private static void showDepositPopup(JFrame parent) {
        ...
        JButton confirmButton = new JButton("Confirm ATM Deposit");
        gbc.gridx = 0;
        gbc.gridy = 6;
        gbc.gridwidth = 2;
        ...
        confirmButton.addActionListener((ActionEvent e) -> {
            ...
            try {
                ...
                if(confirmationResponse == JOptionPane.OK_OPTION) {
                    ...
                    String otp = transactionController.atmDeposit(accountNumber, amount, description, reference.isEmpty() ? "" : reference);
                    if(!otp.isEmpty()){
                        JOptionPane.showMessageDialog(popup, "Your ATM Deposit Code is: "+otp,"ATM Deposit Code",JOptionPane.INFORMATION_MESSAGE);
                        popup.dispose();
                    } else {
